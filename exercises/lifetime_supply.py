...
def calculate_supply(age , amount_perday):
    """
    ...
    """
    # YPUR CODE HERE
    return round((81 - age) * 365 * amount_perday)
  
  # round operator is applied here. The line 19 asks to have an integer as the output.
